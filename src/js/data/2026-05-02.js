dataSetVersion = "2025-08-06"; // Change this when creating a new data set version. YYYY-MM-DD format.
...
{
  name: "Torenia Everdeen",
  img: "Spy-Torenia Everdeen.png",
  opts: {
    game: ["spy"],
    main: true
  }
